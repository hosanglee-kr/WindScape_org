/*
 * ------------------------------------------------------
 * 소스명 : W10_Web_WebSockets_024.cpp
 * 모듈 약어 : W10
 * 모듈명 : Smart Nature Wind Web API (v024) - WebSocket Implementation
 * ------------------------------------------------------
 * 기능 요약:
...
void CL_W10_WebAPI::routeWebSocket() {
	...
	CL_D10_Logger::log(EN_L10_LOG_INFO, "[W10] WebSocket routes initialized (v024)"); // ✅ v024로 변경
}
