/*
 * ------------------------------------------------------
 * 소스명 : W10_Web_Static_025.cpp
 * 모듈 약어 : W10
 * 모듈명 : Smart Nature Wind Web API (v025) - Static Assets Implementation
 * ------------------------------------------------------
 * 기능 요약:
...
// ------------------------------------------------------
namespace W10_Const {
constexpr char MAIN_HTML[] = "/html/SC10_main_019.html";
constexpr char MAIN_CSS[]  = "/html/SC10_main_019.css";
constexpr char MAIN_JS[]   = "/html/SC10_main_019.js";

constexpr char CHART_HTML[] = "/html/SC10_chart_005.html";
constexpr char CHART_CSS[]  = "/html/SC10_chart_005.css";
constexpr char CHART_JS[]   = "/html/SC10_chart_005.js";
}
