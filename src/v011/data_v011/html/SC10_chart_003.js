...
const presetNameMap = {
  ...
  MOUNTAIN: "산바람",
  URBAN_SUNSET: "도심석양",
  // 나머지 프리셋은 main 페이지에서 가져올 예정이지만, 기본 정의
};
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  setInterval(updateCharts, 3000); // 3초마다 차트 데이터 갱신
  updateCharts();
});
...
const chartParam = new Chart(ctxParam, {
  ...
  data: { datasets: [
    ...
    { label: "Fan Limit", borderColor: "#00bcd4", data: [] }, // 차트 파라미터 확장
    { label: "Min Fan", borderColor: "#e91e63", data: [] }, // 차트 파라미터 확장
  ]},
...
const chartTurbThermSig = new Chart(ctxTurbThermSig, {
  type: "line",
  data: { datasets: [
    { label: "Turb Sig", yAxisID: "ySig", borderColor: "#9c27b0", data: [], tension: 0.3 },
    { label: "Turb Len", yAxisID: "yLen", borderColor: "#795548", data: [], tension: 0.3 },
    { label: "Therm Str", yAxisID: "ySig", borderColor: "#8bc34a", data: [], tension: 0.3, borderDash: [5, 5] },
    { label: "Therm Rad", yAxisID: "yLen", borderColor: "#ffc107", data: [], tension: 0.3, borderDash: [5, 5] },
  ]},
  options: {
    ...chartOptions,
    scales: {
...
const chartEvent = new Chart(ctxEvent, {
  type: "line",
  data: { datasets: [
    { label: "Gust", borderColor: "#f44336", data: [], stepped: true },
    { label: "Thermal", borderColor: "#03a9f4", data: [], stepped: true },
  ]},
...
const chartTiming = new Chart(ctxTiming, {
  ...
  data: { datasets: [
    ...
    { label: "Gust Interval (ms)", borderColor: "#e0e0e0", data: [], tension: 0.3 },
    { label: "Thermal Interval (ms)", borderColor: "#bdbdbd", data: [], tension: 0.3 },
  ]},
