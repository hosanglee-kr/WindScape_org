...
public:
    ...
    static void initDefaultConfig(ST_A10_WindConfig &p_cfg) {
        ...
        // web (fallback 기본 경로)
        #ifdef G_A10_DYNIM_WEB_STATIC_FILE_USE
            strlcpy(p_cfg.web.html_file.file, A10_Const::MAIN_PAGE_HTML_FILE, sizeof(p_cfg.web.html_file.file));
            strlcpy(p_cfg.web.html_file.uri , A10_Const::MAIN_PAGE_HTML_URI , sizeof(p_cfg.web.html_file.uri ));
            strlcpy(p_cfg.web.html_file.mime, A10_Const::MAIN_PAGE_HTML_MIME, sizeof(p_cfg.web.html_file.mime));

            strlcpy(p_cfg.web.js_file.file, A10_Const::MAIN_PAGE_JS_FILE, sizeof(p_cfg.web.js_file.file));
            strlcpy(p_cfg.web.js_file.uri , A10_Const::MAIN_PAGE_JS_URI , sizeof(p_cfg.web.js_file.uri ));
            strlcpy(p_cfg.web.js_file.mime, A10_Const::MAIN_PAGE_JS_MIME, sizeof(p_cfg.web.js_file.mime));

            strlcpy(p_cfg.web.css_file.file, A10_Const::MAIN_PAGE_CSS_FILE, sizeof(p_cfg.web.css_file.file));
            strlcpy(p_cfg.web.css_file.uri , A10_Const::MAIN_PAGE_CSS_URI , sizeof(p_cfg.web.css_file.uri ));
            strlcpy(p_cfg.web.css_file.mime, A10_Const::MAIN_PAGE_CSS_MIME, sizeof(p_cfg.web.css_file.mime));
        #endif
